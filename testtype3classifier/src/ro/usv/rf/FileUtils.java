...
public class FileUtils
{
    ...
    protected static String[][] readLearningSetFromFile(String fileName) throws MyException
    {
        ...
        {
            throw new MyException(" We cannot find the scepicified file on USV computer");
        }
        catch (IOException ioe) {
            throw new MyException(" We encountered some errors while trying to read the specified file: " + ioe.getMessage());
        }
        catch (Exception e) {
            throw new MyException(" Other errors: " + e.getMessage());
        }
